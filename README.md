# ☸️ Kubernetes CRD Studio
> Design Custom Resource Definitions (CRDs) with strict OpenAPI validation schemas. Generate custom resource custom YAML templates and Go controller struct boilerplate definitions.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/k8s-crd/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/k8s-crd/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-k8s-crd.git
cd tp-k8s-crd
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/k8s-crd/) |
