# 🔧 Troubleshooting Guide — Kubernetes CRD Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-k8s-crd/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/k8s-crd/)
